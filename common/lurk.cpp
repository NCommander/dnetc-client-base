...
return "@(#)$Id: lurk.cpp,v 1.68 2008/12/30 20:58:41 andreasb Exp $"; }
...
/* ================================================================== */
    ...
    (CLIENT_OS == OS_VMS)      || (CLIENT_OS == OS_DRAGONFLY)
#include <sys/types.h>
  ...
  if (upcount)
  {
   ...
   if (foundif)
   {
     ...
     return 1;
      ...
      (CLIENT_OS == OS_MORPHOS)|| (CLIENT_OS == OS_DRAGONFLY) || \
      (CLIENT_OS == OS_MACOSX) || (CLIENT_OS == OS_VMS) || \
       ...
       for (n = 0, ifr = ifc.ifc_req; n < ifc.ifc_len; n += sizeof(struct ifreq), ifr++)
       {
                         ...
                         &lurker.ifacestowatch[0] ))
         {
               ...
               ((ifr->ifr_flags & (IFF_UP | IFF_RUNNING | IFF_LOOPBACK)) ==     (IFF_UP | IFF_RUNNING)))
           {
             ...
             (CLIENT_OS == OS_DEC_UNIX) || (CLIENT_OS == OS_DRAGONFLY)
